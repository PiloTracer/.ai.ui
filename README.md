...
| **16 `ui-*` skills** | Bootstrap → foundation → spec → copy → build → verify (+ plan audit + deploy) |

See [`APPROACH.md` §6](APPROACH.md#6-skills-we-explicitly-did-not-add) for skills we did not add (coverage via UI-PATTERNS).

**Skills (16):** [`skills/README.md`](skills/README.md) · **Operator:** [`START_HERE.md`](START_HERE.md) · **Playbook:** [`examples/INDEX.md`](examples/INDEX.md)
